...
static snmp_err_t c2smeasurementtable_get_instance(const u32_t *column, const u32_t *row_oid, u8_t row_oid_len, struct snmp_node_instance *cell_instance)
{
   ...
   */
   ...
   if (row_oid_len == 1)
   {
      ...
      This table augments table 'c2sSensor'! Index columns therefore belong to table 'c2sSensor'!
      You may simply call the '*_get_instance' method of this table.
...
static snmp_err_t c2smeasurementtable_get_next_instance(const u32_t *column, struct snmp_obj_id *row_oid, struct snmp_node_instance *cell_instance)
{
   ...
   */
   ...
   This table augments table 'c2sSensor'! Index columns therefore belong to table 'c2sSensor'!
   You may simply call the '*_get_next_instance' method of this table.
